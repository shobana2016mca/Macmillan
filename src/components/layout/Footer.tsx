export default function Footer() {
  return <footer className="border-t p-4"><div className="container bg-grey-lighter p-16 justify-center">

  <div className="sm:flex mb-4">
  <div className="sm:w-50 sm:mt-0 mt-8 h-auto">
      <div className="text-[#4e007a] font-bold mb-2 text-2xl"><h2>Recruitment <span className="text-black text-2xl font-bold ">Agency</span></h2></div>
      <p className="text-grey-darker leading-normal">Sed consequat sapien faucibus quam bibendum convallis quis in nulla. Pellentesque volutpat odio eget diam cursus semper. Sed consequat sapien faucibus quam. </p>
  ...
  <div className="sm:w-3/4 h-auto">
    ...
    <ul className="list-reset leading-normal">
        ...
        <li className="hover:text-orange text-grey-darker mb-2">Browse Jobs</li>
        <li className="hover:text-orange text-grey-darker mb-2">Browse Categories</li>
        <li className="hover:text-orange text-grey-darker mb-2">Candidate Profile</li>
        <li className="hover:text-orange text-grey-darker mb-2">Edit Resume</li>
  ...
  <div className="sm:w-3/4 h-auto sm:mt-0 mt-8">
    ...
    <ul className="list-reset leading-normal">
        ...
        <li className="hover:text-green-dark text-grey-darker">44 534 643 2544</li>
        <li className="hover:text-green-dark text-grey-darker">contact@recruitment.com</li>
        <li className="hover:text-green-dark text-grey-darker">Facebook</li>
        <li className="hover:text-green-dark text-grey-darker">Instagram</li>
        <li className="hover:text-green-dark text-grey-darker">Twitter</li>
    </ul>
...
<div className="container bg-grey-lighter p-16 justify-center">
  ...
  <div className="sm:w-40 sm:mt-0 mt-8 h-auto">
      <div className="text-[#4e007a] font-bold mb-2 "><h2>Recruitment <span className="text-black font-bold ">Agency</span></h2></div>
      
  </div>
  <div className="sm:w-3/5 h-auto">
  <div className="text-[#4e007a] font-bold mb-2">© 2024. Theme by CMSSuperheroes</div>
    {/* <ul className="list-reset leading-normal">
        <li className="hover:text-orange text-grey-darker">One</li>
        <li className="hover:text-orange text-grey-darker">Two</li>
        <li className="hover:text-orange text-grey-darker">Three</li>
